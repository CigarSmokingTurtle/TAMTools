...
class UrlParserWIDGET(object):
    def setupUi(self, Dialog):
        ...
        self.originalUrlWindow = QtWidgets.QTextEdit(Dialog)
        self.originalUrlWindow.setGeometry(QtCore.QRect(20, 50, 761, 87))
        self.originalUrlWindow.setObjectName("originalUrlWindow")
        self.parsedUrlWindow = QtWidgets.QTextEdit(Dialog)
        self.parsedUrlWindow.setGeometry(QtCore.QRect(20, 170, 761, 411))
        self.parsedUrlWindow.setObjectName("parsedUrlWindow")
